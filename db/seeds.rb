...
search = ToolType.create({name: 'Search', description: 'Search is hard.'})
...
bennett = User.create({email: 'bennett.goble@careerbuilder.com', password: '11111111', username: 'Bennett'})
alex_t = User.create({email: 'alex.tharp@careerbuilder.com', password: '11111111', username: 'Alex T.'})
...
eric = User.create({email: 'eric.presley@careerbuilder.com', password: '11111111', username: 'Eric'})
adam = User.create({email: 'adam.parker@careerbuilder.com', password: '11111111', username: 'Adam'})
aaron = User.create({email: 'aaron.killen@careerbuilder.com', password: '11111111', username: 'Aaron'})
todd = User.create({email: 'todd.wisher@careerbuilder.com', password: '11111111', username: 'Todd'})
chris = User.create({email: 'chris.dixon@careerbuilder.com', password: '11111111', username: 'Chris'})
...
c_sharp = Tool.create({name: 'C#', description: 'C# (pronounced as see sharp) is a multi-paradigm programming language encompassing strong typing, imperative, declarative, functional, generic, object-oriented (class-based), and component-oriented programming disciplines. It was developed by Microsoft within its .NET initiative and later approved as a standard by Ecma (ECMA-334) and ISO (ISO/IEC 23270:2006). C# is one of the programming languages designed for the Common Language Infrastructure.', tool_type: programming_language})
...
pg_search = Tool.create({name: 'PgSearch', description: 'PgSearch builds named scopes that take advantage of PostgreSQL''s full text search.', tool_type: search, ugly_name: 'pg_search'})
...
cloud_flare = Tool.create({name: 'Cloudflare', description: 'A content delivery network and distributed domain name server, sitting between the visitor and the CloudFlare user''s hosting provider, thus acting as a reverse proxy for websites.', tool_type: reverse_proxy})
...
ProjectsTool.create({project: project_tec, tool: cloud_flare})
...
UsersProject.create({project: project_cortex, user: alex_t})
UsersProject.create({project: project_cortex, user: bennett})
ProjectsTool.create({project: project_cortex, tool: jquery})
ProjectsTool.create({project: project_cortex, tool: angular_js})
ProjectsTool.create({project: project_cortex, tool: ruby_on_rails})
ProjectsTool.create({project: project_cortex, tool: ruby})
ProjectsTool.create({project: project_cortex, tool: code_climate})
...
ProjectsTool.create({project: project_grrp, tool: cloud_flare})
...
UsersProject.create({project: project_mappingstability, user: aaron})
UsersProject.create({project: project_mappingstability, user: david})
UsersProject.create({project: project_mappingstability, user: todd})
UsersProject.create({project: project_mappingstability, user: chris})
ProjectsTool.create({project: project_mappingstability, tool: fxcop})
ProjectsTool.create({project: project_mappingstability, tool: c_sharp})
...
UsersProject.create({project: project_talentwallet, user: adam})
