...
code_climate = Tool.create({name: 'Coveralls', ugly_name: 'coveralls', description: 'Coveralls is a web service to help you track your code coverage over time, and ensure that all your new code is fully covered. The Coveralls service is language-agnostic and CI-agnostic, but we haven''t yet built easy solutions for all the possibilities as far as repo hosting. Creating an account is fast and easy.', tool_type: code_analyzer})
