...
project_talentwallet = Project.create({name: 'Talent Wallet', description: 'A mobile app designed to capture resume data at career fairs.', project_type: project_type_mobileapplication})
